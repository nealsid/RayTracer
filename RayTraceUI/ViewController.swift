    ...
    @IBAction func startRT(_ sender: Any) {
        ...
        DispatchQueue.global().async(group: group) { () in
            raytraceWorld(camera: cameraLocation,
                          ...
                          ambientLight: CGColor(red: CGFloat(self.ambientLightingR.doubleValue),
                                                green: CGFloat(self.ambientLightingG.doubleValue),
                                                blue: CGFloat(self.ambientLightingB.doubleValue),
                                                alpha: 1.0),
